...
На выбор предоставляются колоды карт следующего размера: 36 или 52 - используется по умолчанию.
  ...
  -Итак вам сдали две карты, вы смотрите на сумму их очков и принимаете решение брать еще карту, в этом случае введите «yes» или «y».
  ...
  -Как только сумма ваших карт достигнет 21 введите «win» или «w», тогда вы победите.
   Учтите, что если вы введете эту команду и ваш счёт меньше 21 и оставшихся игроков больше 1, то автоматически проиграете.
